...
namespace QuantLib {
    ...
    BTPItaliaCouponPricer::BTPItaliaCouponPricer(Handle<YieldTermStructure> nominalTermStructure)
    : nominalTermStructure_(std::move(nominalTermStructure)) {
        registerWith(nominalTermStructure_);
    }

    BTPItaliaCouponPricer::BTPItaliaCouponPricer(Handle<CPIVolatilitySurface> capletVol,
    ...
    void BTPItaliaCouponPricer::setCapletVolatility(
    ...
    Real BTPItaliaCouponPricer::floorletPrice(Rate effectiveFloor) const{
        Real floorletPrice = optionletPrice(Option::Put, effectiveFloor);
        return floorletPrice;
    }

    Real BTPItaliaCouponPricer::capletPrice(Rate effectiveCap) const{
        Real capletPrice = optionletPrice(Option::Call, effectiveCap);
        return capletPrice;
    }


    Rate BTPItaliaCouponPricer::floorletRate(Rate effectiveFloor) const {
        return optionletRate(Option::Put, effectiveFloor);
    }

    Rate BTPItaliaCouponPricer::capletRate(Rate effectiveCap) const{
        return optionletRate(Option::Call, effectiveCap);
    }


    Real BTPItaliaCouponPricer::optionletPriceImp(Option::Type,
                                            Real,
                                            Real,
                                            Real) const {
    ...
    Real BTPItaliaCouponPricer::optionletPrice(Option::Type optionType,
    ...
    Real BTPItaliaCouponPricer::optionletRate(Option::Type optionType,
                                        Real effStrike) const {
    ...
    void BTPItaliaCouponPricer::initialize(const InflationCoupon& coupon) {
        coupon_ = dynamic_cast<const BTPItaliaCoupon*>(&coupon);
    ...
    Real BTPItaliaCouponPricer::swapletPrice() const {
        QL_REQUIRE(discount_ != Null<Real>(), "no nominal term structure provided");
        return swapletRate() * coupon_->accrualPeriod() * discount_;
    }


    Rate BTPItaliaCouponPricer::swapletRate() const {
        return fixedRate_;
    }


    Rate BTPItaliaCouponPricer::accruedRate(Date settlementDate) const {
        return fixedRate_ * coupon_->indexRatio(settlementDate);
    }
