...
/*! \file BTPItaliaCouponPricer.hpp
    \brief zero inflation-coupon pricer
 */

#ifndef quantlib_btpitaliacouponpricer_hpp
#define quantlib_btpitaliacouponpricer_hpp
...
namespace QuantLib {
    ...
    */
    class BTPItaliaCouponPricer : public InflationCouponPricer {
      public:
        explicit BTPItaliaCouponPricer(Handle<YieldTermStructure> nominalTermStructure = Handle<YieldTermStructure>());

        explicit BTPItaliaCouponPricer(Handle<CPIVolatilitySurface> capletVol,
