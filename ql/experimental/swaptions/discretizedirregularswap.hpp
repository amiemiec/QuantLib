...
#ifndef quantlib_discretized_irregular_swap_hpp
#define quantlib_discretized_irregular_swap_hpp
...
namespace QuantLib {
    ...
    class DiscretizedIrregularSwap : public DiscretizedAsset {
      public:
        DiscretizedIrregularSwap(const IrregularSwap::arguments&,
      ...
      private:
        IrregularSwap::arguments arguments_;
