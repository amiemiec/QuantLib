...
namespace QuantLib {
    ...
    DiscretizedIrregularSwaption::DiscretizedIrregularSwaption(const IrregularSwaption::arguments& args,
    ...
    : DiscretizedOption(boost::shared_ptr<DiscretizedAsset>(),
      ...
      arguments_(args) {
        ...
        underlying_ = boost::shared_ptr<DiscretizedAsset>(
                                            new DiscretizedIrregularSwap(arguments_,
                                                                         referenceDate,
                                                                         dayCounter));
    }

    void DiscretizedIrregularSwaption::reset(Size size) {
