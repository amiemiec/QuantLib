...
namespace QuantLib {
    ...
    : LatticeShortRateModelEngine<IrregularSwap::arguments,
                                  IrregularSwap::results>(model, timeSteps),
    ...
    TreeIrregularSwapEngine::TreeIrregularSwapEngine(
                              ...
                              const Handle<YieldTermStructure>& termStructure)
    : LatticeShortRateModelEngine<IrregularSwap::arguments,
                                  IrregularSwap::results>(model, timeGrid),
      termStructure_(termStructure) {
        registerWith(termStructure_);
    }

    void TreeIrregularSwapEngine::calculate() const {
        ...
        DiscretizedIrregularSwap swap(arguments_, referenceDate, dayCounter);
