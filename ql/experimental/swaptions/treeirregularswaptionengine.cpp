...
#include <ql/experimental/swaptions/discretizedirregularswaption.hpp>
...
namespace QuantLib {
    ...
    : LatticeShortRateModelEngine<IrregularSwaption::arguments,
                                  IrregularSwaption::results>(model, timeSteps),
    ...
    TreeIrregularSwaptionEngine::TreeIrregularSwaptionEngine(
                              ...
                              const Handle<YieldTermStructure>& termStructure)
    : LatticeShortRateModelEngine<IrregularSwaption::arguments,
                                  IrregularSwaption::results>(model, timeGrid),
      termStructure_(termStructure) {
        registerWith(termStructure_);
    }

    void TreeIrregularSwaptionEngine::calculate() const {

        QL_REQUIRE(arguments_.settlementType==IrregularSettlement::Physical,
        ...
        DiscretizedIrregularSwaption swaption(arguments_, referenceDate, dayCounter);
