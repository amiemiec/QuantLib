...
#ifndef quantlib_tree_irregular_swap_engine_hpp
#define quantlib_tree_irregular_swap_engine_hpp
...
namespace QuantLib {
    ...
    */
    ...
    : public LatticeShortRateModelEngine<IrregularSwap::arguments,
      ...
      public:
        ...
        */
        //@{
        TreeIrregularSwapEngine(const boost::shared_ptr<ShortRateModel>&,
                              Size timeSteps,
