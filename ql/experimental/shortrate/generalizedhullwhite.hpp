    ...
    class GeneralizedHullWhite::Dynamics
      ...
      public:
        Dynamics(const Parameter& fitting,
                 const Handle<YieldTermStructure>&  alpha,
        ...
        : ShortRateDynamics(boost::shared_ptr<StochasticProcess1D>(
          ...
          fitting_(fitting), 
		  //DEBUG 
		  oas_(InterestRate(0.0,Actual365Fixed(),Continuous,NoFrequency)) {}
        ...
        Real shortRate(Time t, Real x) const {
			...
			//return x + fitting_(t);
            //DEBUG
			return x + fitting_(t) + oas_.impliedRate(oas_.compoundFactor(t),Actual365Fixed(),Continuous,NoFrequency,t);
		}

		void setOAS(InterestRate oas) { oas_ = oas; } 
